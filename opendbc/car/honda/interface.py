  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    if ret.flags & HondaFlags.BOSCH:
      ...
      if ret.flags & HondaFlags.BOSCH_RADARLESS:
        ...
        ret.longitudinalActuatorDelay = 0.26  # measured ~0.26s effective lag across vEgo 2-9 m/s; 0.5s overshoots brake commands
    else:
    ...
    if candidate == CAR.HONDA_CIVIC:
      ...
      ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kpV = [[0, 10], [0.0427, 0.4267]]
      ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kiV = [[0, 10], [0.0107, 0.1067]]
