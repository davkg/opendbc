...
class TestHondaBoschRadarlessLongSafety(common.LongitudinalAccelSafetyTest, HondaButtonEnableBase,
  ...
  """
  TX_MSGS = [[0xE4, 0], [0x296, 2], [0x33D, 0], [0x1C8, 0], [0x30C, 0], [0x1EF, 0], [0x35E, 0], [0x6CD5554, 0], [0xF31AA54, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0xE4, 0x33D, 0x1C8, 0x30C, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54]}
  RELAY_MALFUNCTION_ADDRS = {0: (0xE4, 0x1C8, 0x30C, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54)}
  ...
  def test_fwd_hook(self):
    fwd_addrs = {2: [0xE4, 0x33D, 0x30C, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54]}
    blocked_addrs = {2: [0xE4, 0x33D, 0x1C8, 0x30C, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54]}
