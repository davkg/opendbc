...
class TestHondaBoschRadarlessSafetyBase(TestHondaBoschSafetyBase):
  ...
  TX_MSGS = [[0xE4, 0], [0x296, 2], [0x33D, 0], [0x1EF, 0], [0x35E, 0], [0x6CD5554, 0], [0xF31AA54, 0], [0x6CD5557, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0xE4, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54, 0x6CD5557]}
  # STEERING_CONTROL, SPEED_LIMIT_DASH_DISPLAY, CAMERA_MESSAGES, LANE_PATH, LKAS_HUD_2, HUD_OBJECTS
  RELAY_MALFUNCTION_ADDRS = {0: (0xE4, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54, 0x6CD5557)}
...
class TestHondaBoschRadarlessLongSafety(common.LongitudinalAccelSafetyTest, HondaButtonEnableBase,
  ...
  """
  TX_MSGS = [[0xE4, 0], [0x296, 2], [0x33D, 0], [0x1C8, 0], [0x30C, 0], [0x1EF, 0], [0x35E, 0], [0x6CD5554, 0], [0xF31AA54, 0], [0x6CD5557, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0xE4, 0x33D, 0x1C8, 0x30C, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54, 0x6CD5557]}
  RELAY_MALFUNCTION_ADDRS = {0: (0xE4, 0x1C8, 0x30C, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54, 0x6CD5557)}
  ...
  def test_fwd_hook(self):
    cam_fwd = [0xE4, 0x33D, 0x30C, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54, 0x6CD5557]  # stock 0x1C8 forwarded from camera
    cam_blocked = cam_fwd + [0x1C8]  # OP transmitting ACC_CONTROL -> stock 0x1C8 blocked
