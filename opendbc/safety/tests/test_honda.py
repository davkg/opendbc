...
class TestHondaBoschRadarlessSafetyBase(TestHondaBoschSafetyBase):
  ...
  TX_MSGS = [[0xE4, 0], [0x296, 2], [0x33D, 0], [0x1EF, 0], [0x35E, 0], [0x6CD5554, 0], [0xF31AA54, 0]]
  FWD_BLACKLISTED_ADDRS = {2: [0xE4, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54]}
  # STEERING_CONTROL, SPEED_LIMIT_DASH_DISPLAY, CAMERA_MESSAGES, LANE_PATH, LKAS_HUD_2
  RELAY_MALFUNCTION_ADDRS = {0: (0xE4, 0x33D, 0x1EF, 0x35E, 0x6CD5554, 0xF31AA54)}
